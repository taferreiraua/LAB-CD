...
ggplot(nao_medalhistas, aes(x=Idade, y=Peso)) +
  ...
  geom_richtext(aes(x=15, y=130, label=paste0("<span style='font-size:45pt;'>", 'COR ', 
...
ggsave(units='px', height=2500, width=8000, 
       filename='C:/Users/Thays Ferreira/Documents/LAB/Script/Correlacoes/peso_idade/p1.png')
...
ggplot(medalhistas, aes(x=Idade, y=Peso)) +
  geom_point(size=4, alpha=.5) +
...
ggsave(units='px', height=1700, width=8000, 
       filename='C:/Users/Thays Ferreira/Documents/LAB/Script/Correlacoes/peso_idade/p2.png')
...
ggdraw(plot) +
  draw_image(magick::image_read('C:/Users/Thays Ferreira/Documents/LAB/Script/Correlacoes/peso_idade/p1.png'),
             x=0, y=.207, scale=1) +
  draw_image(magick::image_read('C:/Users/Thays Ferreira/Documents/LAB/Script/Correlacoes/peso_idade/p2.png'),
             x=0, y=-.265, scale=1)
...
ggsave(units='px', height=4000, width=7200, filename='peso_idade.png')
